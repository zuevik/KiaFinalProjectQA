from . import (By, wait_to_be_visible, Select, time, driver,
               HomePage, configurationPage, converter_of_name, carConfigPage, proceed)
...
def test_configuration_button_test(driver):
    ...
    conf_page.car_model_click('ProCeed')
    time.sleep(3)
    car_config_page.choose_the_engine_click(proceed, 'GTL', 1.5, 'Automatyczna')
